...
\begin{frame}[label={sec:orgd8c5c11}]{Exercise: Reading the Bode diagram}
\begin{center}
...
\begin{frame}[label={sec:org18ee3c4}]{Stability of the closed-loop system}
 \begin{center}
 \begin{tikzpicture}
...
\begin{frame}[label={sec:orgbc96810}]{Stability of the closed-loop system}
 \begin{center}
 \begin{tikzpicture}
\tikzset{node distance=2cm, 
    block/.style={rectangle, draw, minimum height=12mm, minimum width=14mm},
...
\begin{frame}[label={sec:orgbbc0a22}]{From loop gain to closed-loop gain}
 \begin{center}
 \begin{tikzpicture}
\tikzset{node distance=2cm, 
    block/.style={rectangle, draw, minimum height=12mm, minimum width=14mm},
