...
\node[align=center, text width=8cm] at (12,8) {Which of the below figures shows the correct mapping of the continuous-time poles using the \textbf{backward difference} $z = \frac{1}{1-sh}$ with $h=1$?};
