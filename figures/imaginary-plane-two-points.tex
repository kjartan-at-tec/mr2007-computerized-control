...
\node[circle, fill, pin=-20:{$u(k)=\mathrm{e}^{i\frac{\pi}{12}k}, \; k=2$}, inner sep=0.5mm] at (axis cs: 30, 1) {};
\node[circle, fill, pin=-20:{$H(\mathrm{e}^{i\frac{\pi}{12}})$}, inner sep=0.5mm] at (axis cs: -60, 2) {};
\end{polaraxis}
\end{tikzpicture}
\end{document}
