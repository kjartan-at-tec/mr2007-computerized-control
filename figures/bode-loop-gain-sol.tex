...
\begin{tikzpicture}
  \begin{semilogxaxis} [
    ...
    \addplot+ shell[thick,black, dashed, no marks, prefix=pgfshell_, id=bodephd,] {julia -q --eval  "G=\sysCont  H=c2d(G, \samplePeriod); print_bode_phase(H, -2, 2);"};
  \end{semilogxaxis}
  \begin{loglogaxis} [
      ylabel=$|G_o(i\omega)|$,
      yshift = 4.8cm, 
    ...
    \addplot+ shell[thick,black, dashed, no marks, prefix=pgfshell_, id=bodemd,] {julia -q --eval  "G=\sysCont  H=c2d(G, \samplePeriod); print_bode_mag(H, -2, 2);"};
  \end{loglogaxis}
  ...
  \begin{axis} [
    ...
    \addplot+ shell[thick,black, dashed, no marks, prefix=pgfshell_, id=nyqd,] {julia -q --eval  "G=\sysCont  H=c2d(G, \samplePeriod); print_nyq_real_im(H, -1, 1);"};
