...
\addplot+[no markers, ultra thick, black, domain=0:1, samples=20] (0.25*180, x);
\addplot+[no markers, ultra thick, black, dashed, domain=1:1.7, samples=20] (0.25*180, x);
\addplot+[no markers, ultra thick, black, domain=0:1, samples=20] (-0.25*180, x);
\addplot+[no markers, ultra thick, black, dashed, domain=1:1.7, samples=20] (-0.25*180, x);
%\addplot+[no markers, ultra thick, black, domain=0:1, samples=20] (-0.25*180, 1.5*x);
