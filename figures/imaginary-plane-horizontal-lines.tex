...
\addplot+[data cs=cart, no markers, ultra thick, red, domain=-1:0, samples=20] (1.5*x, 1);
\addplot+[data cs=cart, no markers, ultra thick, red, domain=0:1, samples=20] (1.5*x, 1);
