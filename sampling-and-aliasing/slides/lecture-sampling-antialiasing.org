...
** The impulse modulation model
 ...
 #+beamer: \pause
	...
	# = \sum_{k=-\infty}^{\infty} f(t)\delta(t-kh) = \sum_{k=-\infty}^{\infty} f(kh) \delta(t-kh) \]
...
*** Resources
[[https://youtu.be/SxNVcCVj-3c][Dr. Trefor Bazett on the Dirac delta function, ]]
[[https://youtu.be/TIcfY19dk0c][Prof Iain Collings explains convolution with the delta, ]]
[[https://youtu.be/nHguB7MvCfI][Steven Fenton on the dirac comb and sampling]]
...
has Fourier transform 
   ...
   \footnotesize
*** Resources
[[https://youtu.be/TLWE388JWGs][Prof Iain Collings on Complex numbers and real signals]]
...
*** Notes							   :noexport:
    ...
    - wN  = pi/h = 3/2 pi/T
** Exercise 4: Fourier transform of a sampled sinusoid
