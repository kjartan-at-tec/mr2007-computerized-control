...
\section{Intro}
\label{sec:org3df4099}

\begin{frame}[label={sec:org965c678}]{Sistemas híbridas}
\begin{center}
...
\label{sec:org4cb9dd2}
\begin{frame}[label={sec:org328ac47}]{Retos en control computarizado - fenómeno de alias}
\begin{columns}
...
\begin{frame}[label={sec:orgeffdfdc}]{Efecto de alias en imágenes}
\begin{center}
...
\begin{frame}[label={sec:org0d9946e}]{El teorema del muestreo}
Shannon y Nyquist:
...
\begin{frame}[label={sec:orgdd68267}]{Un modelo del muestreo}
...
\begin{frame}[label={sec:orgffa5daa}]{Transformada de Fourier de la señal muestreada}
...
\label{sec:org86e87e8}
\begin{frame}[label={sec:org966f245}]{Transformada de Fourier de un exponencial complejo}
...
\begin{frame}[label={sec:orgb8fadeb}]{Ejercicio 1: La transformada de Fourier de una sinusoide}
...
scatter/@pre marker code/.code={\scope[rotate=90*\sign,yshift=-2pt]}
  ...
  \end{tikzpicture}
\end{frame}
\begin{frame}[label={sec:orgf108393}]{Ejercicio 2: Dos sinusoides}
...
\end{tikzpicture}
\end{frame}
\begin{frame}[label={sec:org3a1faf6}]{Ejercicio 3: Transformada de Fourier de una sinusoide muestreada}
...
\end{enumerate}
\end{frame}
\begin{frame}[label={sec:org0541b23}]{Ejercicio 4: Transformada de Fourier de una sinusoide muestreada}
...
scatter/@pre marker code/.code={\scope[rotate=90*\sign,yshift=-2pt]}
  ...
  \end{tikzpicture}
\end{frame}
\begin{frame}[label={sec:org6140b7e}]{Frecuencia de alias}
...
\begin{frame}[label={sec:orge09d7fd}]{Ejemplo del fenómeno de alias}
\begin{center}
