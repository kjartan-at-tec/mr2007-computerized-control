...
\section{Intro}
\label{sec:org8e530fe}

\begin{frame}[label={sec:orge299b5c}]{Sistemas híbridas}
\begin{center}
...
\label{sec:org378c9f9}
\begin{frame}[label={sec:org7d48858}]{Retos en control computarizado - fenómeno de alias}
\begin{columns}
...
\begin{frame}[label={sec:org89dcea8}]{Efecto de alias en imágenes}
\begin{center}
...
\begin{frame}[label={sec:orgaff6463}]{El teorema del muestreo}
Shannon y Nyquist:
...
\begin{frame}[label={sec:org0b6922d}]{Un modelo del muestreo}
...
\begin{frame}[label={sec:orgd969fa8}]{Transformada de Fourier de la señal muestreada}
...
\label{sec:orgaee7b74}
\begin{frame}[label={sec:orgce5dc57}]{Transformada de Fourier de un exponencial complejo}
...
\begin{frame}[label={sec:orgb0caca1}]{Ejercicio 1: La transformada de Fourier de una sinusoide}
...
scatter/@pre marker code/.code={\scope[rotate=90*\sign,yshift=-2pt]}
  ...
  \end{tikzpicture}
\end{frame}
\begin{frame}[label={sec:org94ae1b1}]{Ejercicio 2: Dos sinusoides}
...
\end{tikzpicture}
\end{frame}
\begin{frame}[label={sec:org390b12e}]{Ejercicio 3: Transformada de Fourier de una sinusoide muestreada}
...
\end{enumerate}
\end{frame}
\begin{frame}[label={sec:orgca48053}]{Ejercicio 4: Transformada de Fourier de una sinusoide muestreada}
...
scatter/@pre marker code/.code={\scope[rotate=90*\sign,yshift=-2pt]}
  ...
  \end{tikzpicture}
\end{frame}
\begin{frame}[label={sec:org4ac9587}]{Frecuencia de alias}
...
\begin{frame}[label={sec:org4debca6}]{Ejemplo del fenómeno de alias}
\begin{center}
