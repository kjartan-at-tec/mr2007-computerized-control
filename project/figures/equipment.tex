...
\begin{tikzpicture}
  \begin{scope}
    \node[anchor=south west,inner sep=0] (image2) at (0,0) {\includegraphics[width=0.4\textwidth]{humusoftcard-large-scaled.png}};
...
%    \end{scope}
  ...
  \begin{scope}[xshift=5cm, yshift=0]
    \node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=0.4\textwidth]{TecQmaletinoutside.png}};
