...
\begin{frame}[label={sec:org8396314}]{The sensitivity and the complementary sensitivity}
...
\begin{frame}[label={sec:org68f0c78}]{The sensitivity and the complementary sensitivity - Solution}
\end{frame}

\begin{frame}[label={sec:orgd08a7b7}]{The sensitivity and the complementary sensitivity - Solution}
\pgfmathsetmacro{\Smag}{0.12}
\pgfmathsetmacro{\Sarg}{70}
\pgfmathsetmacro{\Tmag}{0.98}
\pgfmathsetmacro{\Targ}{-6}
