...
\label{sec:org17f3c07}
\begin{frame}[label={sec:orgeac3a45}]{Tres conceptos claves}
\begin{enumerate}
...
\begin{frame}[label={sec:orgf4eeef0}]{Concepto clave 1) Los polos del sistema en lazo cerrado}
\begin{center}
\includegraphics[height=0.8\textheight]{../../figures/screenshot-2020-07-14.png}
\end{center}
\end{frame}

\begin{frame}[label={sec:org004fe2d}]{Concepto clave 2) Las funciones de sensibilidad y sensibilidad complementaria}
\end{frame}
\begin{frame}[label={sec:org702adbb}]{Controlador de dos grados de libertad}
\begin{center}
...
\begin{frame}[label={sec:org343ebf9}]{Sensibilidad y sensibilidad complementaria}
\begin{center}
...
\begin{frame}[label={sec:orgac7cde8}]{Sensibilidad y sensibilidad complementaria -  Solución}
...
\begin{frame}[label={sec:org88365bf}]{La función de sensibilidad}
...
\begin{frame}[label={sec:orgc7687c0}]{La función de sensibilidad - ejercicio}
...
\begin{frame}[label={sec:org13d8169}]{La función de sensibilidad - solución}
\begin{columns}
\begin{column}{0.65\columnwidth}
    \begin{center}
    \begin{tikzpicture}
...
\label{sec:orgb82353f}
\begin{frame}[label={sec:orgbdf2dad}]{Controlador de dos grados de libertad}
\begin{center}
\includegraphics[width=0.7\linewidth]{../../figures/2dof-block-explicit}
\end{center}
...
\begin{frame}[label={sec:org0bf267e}]{Controlador de dos grados de libertad}
\begin{center}
\includegraphics[width=0.7\linewidth]{../../figures/2dof-block-explicit}
\end{center}
\begin{align*}
...
\section{RST}
\label{sec:org76211ca}

\begin{frame}[label={sec:org73a2b7f}]{Procedimiento - asignación de polos}
...
\begin{frame}[label={sec:orgf23aaf5}]{Procedimiento}
Dado modelo del proceso \(H(z)=\frac{B(z)}{A(z)}\), y especificaciones de polos deseados del sistema en lazo cerrado \(A_{cl}(z) = (z-\alpha_1)(z-\alpha_2) \cdots (z-\alpha_{n_c})\)
\begin{enumerate}
\setcounter{enumi}{3}
\item Elige
...
\begin{frame}[label={sec:org55d802c}]{Concepto clave 3) Determinando el orden del controlador}
...
\section{Ejemplo}
\label{sec:orgd40b2e8}
\begin{frame}[label={sec:org8fcfa55}]{Ejemplo - Control de nivel de una presa}
\begin{center}
...
\begin{frame}[label={sec:orga78f9d9}]{Ejemplo - Control de nivel de una presa}
\begin{center}
...
\begin{frame}[label={sec:org77bd9e3}]{Ejemplo - Control de nivel de una presa}
\alert{Dinámica del proceso}
...
\begin{frame}[label={sec:orga1ce194}]{Ejemplo - Control de nivel de una presa}
...
\begin{frame}[label={sec:org1f32865}]{Ejemplo - Control de nivel de una presa}
\begin{enumerate}
\setcounter{enumi}{2}
...
\begin{frame}[label={sec:orgba41f81}]{Ejemplo - Control de nivel de una presa}
\begin{enumerate}
\setcounter{enumi}{3}
...
\section{Ejercicios}
\label{sec:org27fb194}
\begin{frame}[label={sec:orge94b468}]{Ejercicios}
\end{frame}
\begin{frame}[label={sec:org0e4d641}]{Concepto clave 3) Determinando el orden del controlador}
...
\begin{frame}[label={sec:orgd25a365}]{Determinando el orden del controlador - Ejercicio 1}
