...
\begin{frame}[label={sec:orgc29d609}]{Tiempo de muestreo}
\alert{Un tiempo de muestreo, \(h\), adecuado depende de la velocidad del proceso a controlar y/o la velocidad deseada del sistema en lazo cerrado}  
\begin{block}{Reglas de oro (Åström \& Wittenmark)}
\begin{enumerate}
\setcounter{enumi}{1}
...
\label{sec:org01eeed2}
\begin{frame}[label={sec:orgaf9d8c3}]{Diseño por asignación de polos}
\end{frame}
\begin{frame}[label={sec:org723dd0f}]{Asignación de polos - Un ejemplo}
\begin{center}
\begin{tikzpicture}
...
\begin{frame}[label={sec:org6d69e7a}]{Asignación de polos}
\begin{center}
\begin{tikzpicture}
\tikzset{node distance=2cm, 
    block/.style={rectangle, draw, minimum height=12mm, minimum width=14mm},
...
\begin{frame}[label={sec:org2b74e92}]{Asignación de polos - Solución}
\begin{center}
\begin{tikzpicture}
\tikzset{node distance=2cm, 
    block/.style={rectangle, draw, minimum height=12mm, minimum width=14mm},
...
\begin{frame}[label={sec:org7bff1cd}]{Asignación de polos}
\alert{Ligas}
...
\begin{frame}[label={sec:org39e5d99}]{Sensibilidad y sensibilidad complementaria -  Solución}
\end{frame}
\begin{frame}[label={sec:orgb4c7b73}]{Sensibilidad y sensibilidad complementaria -  Solución}
\pgfmathsetmacro{\Smag}{0.12}
\pgfmathsetmacro{\Sarg}{70}
\pgfmathsetmacro{\Tmag}{0.98}
\pgfmathsetmacro{\Targ}{-6}
