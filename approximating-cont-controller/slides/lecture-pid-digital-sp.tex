...
=======
\begin{frame}[label={sec:org7d172e5}]{PID tipo ISA - parte derivativa, solución}
>>>>>>> b22b6989bdef1c67fd3782e3ca70ba70c94ec33b
\[ F(s) = K_c\left( 1 + \frac{1}{T_i s} + \frac{T_d s}{\frac{T_d}{N} s + 1}\right), \quad N \approx 3\; - \; 10 \]
...
=======
\begin{frame}[label={sec:orgd101444}]{PID con accción derivada sobre la variable de proceso}
>>>>>>> b22b6989bdef1c67fd3782e3ca70ba70c94ec33b
\begin{center}
...
=======
\begin{frame}[label={sec:org9ccb9cf}]{Tabla de  Ziegler-Nichols - ejercicio}
>>>>>>> b22b6989bdef1c67fd3782e3ca70ba70c94ec33b
