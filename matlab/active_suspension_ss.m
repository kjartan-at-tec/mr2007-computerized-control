...
P1 = w0*exp(i*[3*pi/4, 7*pi/8]); % design in continuous time
P2 = conj(P1);
P = exp([P1, P2]*h)
...
pc = 0.99*w0*exp(i*[3*pi/4, -3*pi/4, 7*pi/8, -7*pi/8]);
P = exp(h*pc)
...
print -dpdf hw4_closed_loop_step_vt17.pdf
...
print -dpdf hw4_closed_loop_polse_vt17.pdf
