...
\begin{frame}[label={sec:org34fad2a}]{Example - The Apollo lunar module}
...
\begin{frame}[label={sec:orgf88498e}]{Example - The Apollo lunar module}
 \begin{align*}
