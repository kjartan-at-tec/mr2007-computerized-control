...
\section{Intro}
\label{sec:orgf3e95ba}
\begin{frame}[label={sec:orgb450b0e}]{Repetición: Controlador discreto para el brazo del disco duro}
Usando \(J=1\) y  \(h=1\).
\begin{center}
\begin{tikzpicture}
...
\begin{frame}[label={sec:org746971b}]{Repetición: Controlador discreto para el brazo del disco duro}
\begin{center}
\includegraphics[width=0.6\linewidth]{rlocus-disk-arm.discrete}
\end{center}
\end{frame}

\begin{frame}[label={sec:org7782544}]{Algebra en diagramas de bloque}
\begin{center}
\begin{tikzpicture}
\tikzset{node distance=2cm, 
    block/.style={rectangle, draw, minimum height=12mm, minimum width=14mm},
...
\begin{frame}[label={sec:orgdcbdaeb}]{Algebra en diagramas de bloque - pasos en detalle}
Usando \[U(z) = U_1(z) - U_2(z) = F_f(z)\Theta_{ref}(z) - F_b(z)\Theta(z), \quad \text{y}\]
\[ \Theta(z) = H(z)U(z), \quad \text{obtenemos} \]
...
\begin{frame}[label={sec:org65ecc81}]{Estabilidad del sistem an lazo cerrado}
\[ \Theta(z) = \underbrace{\frac{F_f(z)H(z)}{1 + F_b(z)H(z)}}_{H_c{z}} \Theta_{ref}(z). \]
...
\begin{frame}[label={sec:orge1bce41}]{Ejercicio}
\begin{center}
\begin{tikzpicture}
\tikzset{node distance=2cm, 
    block/.style={rectangle, draw, minimum height=12mm, minimum width=14mm},
...
\label{sec:orgd3d7932}

\begin{frame}[label={sec:orgdc82a5f}]{Estabilidad para el control del brazo del disko duro}
\begin{center}
\begin{tikzpicture}
\tikzset{node distance=2cm, 
    block/.style={rectangle, draw, minimum height=12mm, minimum width=14mm},
...
\begin{frame}[label={sec:orgd5a1660}]{Estabilidad para el control del brazo del disko duro}
