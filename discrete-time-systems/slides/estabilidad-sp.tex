...
\section{Intro}
\label{sec:orgb787199}
\begin{frame}[label={sec:orgec07072}]{Repetición: Controlador discreto para el brazo del disco duro}
...
\begin{frame}[label={sec:org46c890c}]{Repetición: Controlador discreto para el brazo del disco duro}
Usando \(J=1\) y  \(h=1\).
\begin{center}
\begin{tikzpicture}
\tikzset{node distance=2cm, 
...
\begin{frame}[label={sec:org24a1a81}]{Repetición: Controlador discreto para el brazo del disco duro}
\begin{center}
\includegraphics[width=0.6\linewidth]{rlocus-disk-arm.discrete}
\end{center}
\end{frame}

\begin{frame}[label={sec:org6a402a9}]{Algebra en diagramas de bloque}
\begin{center}
\begin{tikzpicture}
\tikzset{node distance=2cm, 
    block/.style={rectangle, draw, minimum height=12mm, minimum width=14mm},
...
\begin{frame}[label={sec:org4a8966b}]{Algebra en diagramas de bloque - pasos en detalle}
Usando \[U(z) = U_1(z) - U_2(z) = F_f(z)\Theta_{ref}(z) - F_b(z)\Theta(z), \quad \text{y}\]
\[ \Theta(z) = H(z)U(z), \quad \text{obtenemos} \]
...
\begin{frame}[label={sec:orga7fc98d}]{Estabilidad del sistem an lazo cerrado}
\[ \Theta(z) = \underbrace{\frac{F_f(z)H(z)}{1 + F_b(z)H(z)}}_{H_c{z}} \Theta_{ref}(z). \]
...
\begin{frame}[label={sec:orgdaf6d33}]{Ejercicio}
\begin{center}
\begin{tikzpicture}
\tikzset{node distance=2cm, 
    block/.style={rectangle, draw, minimum height=12mm, minimum width=14mm},
...
\begin{frame}[label={sec:orgb9b4f00}]{Solución}
...
\label{sec:org6dba03c}

\begin{frame}[label={sec:orgb17a623}]{Estabilidad para el control del brazo del disko duro}
\begin{center}
\begin{tikzpicture}
\tikzset{node distance=2cm, 
    block/.style={rectangle, draw, minimum height=12mm, minimum width=14mm},
...
\begin{frame}[label={sec:org42736b2}]{Estabilidad para el control del brazo del disko duro}
